...
if ($nextstage>0) {
        ...
        if ($developementcost<$sessionmoney) {
            ...
            $command = mysqli_query($connection,"INSERT INTO War_Country (username, Construction_id, completion_time, war_group) VALUES ('$notpermanentusername', $nextstage, $completion_time, $notpermanentwar_group) ;");
            if (!$command) {
              die("Query failed: " .mysqli_error($connection) );
            }
